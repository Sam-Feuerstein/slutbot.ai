...
export function getPresetMetaDescription(preset: HomePreset): string {
  ...
  return `Generate ${preset.title} ${motion} with SLUTBOT AI. Upload a photo, open the ${preset.title} preset, and create uncensored adult content in minutes. 18+ only.`;
}
