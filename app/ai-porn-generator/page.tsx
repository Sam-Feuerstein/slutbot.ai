...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Use the SLUTBOT AI nude generator to create uncensored AI slut images and 5-second videos. Upload a photo, pick a preset, pay with Slutcoins. 18+ only.',
  path: GENERATOR_PATH,
  ogTitle: 'AI Nude Generator Online | SLUTBOT AI',
});
