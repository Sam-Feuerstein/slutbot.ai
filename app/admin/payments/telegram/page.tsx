  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      <PageHeader
        ...
        description="Same Erogram VIP bot. Packs are named SLUTBOT Ecstasy / Passion / Desire / Flirt / Tease so they show up on that bot without mixing into VIP membership."
        action={
